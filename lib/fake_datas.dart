...
class FakeDatas {
  ...
  /// ]
  /// ```
  static List<ArticleModel> articles = <Map<String, dynamic>>[
    <String, dynamic>{
      'id': 7,
      'title': 'Comment utiliser google ads',
      'slug': 'comment-utiliser-google-ads',
      'description':
          'Aujourd’hui, tout un chacun peut créer et mettre en ligne une campagne publicitaire sur Google Ads. La firme de Mountain View met à votre disposition une plateforme facile à manipuler pour lancer une publicité Google en quelques minutes',
      'createdAt': '2023-08-14T17:51:21.547Z',
      'updatedAt': '2023-08-14T17:51:21.547Z',
      'deletedAt': null,
      'picture': {
        'src': '75a534fc-6617-4877-bce9-3649bf5d38e8-842127201-files/images/books-3.jpg',
        'alt': "Image du projet 'Mon site web 6 n° 3'",
      },
      'category': {
        'id': 7,
        'title': 'Informations',
    ...
    <String, dynamic>{
      ...
      'deletedAt': null,
      'picture': {
        'src': '75a534fc-6617-4877-bce9-3649bf5d38e8-842127201-files/images/blogs.jpg',
        'alt': "Image du projet 'Mon site web 6 n° 3'",
      },
      'category': {
        'id': 6,
    ...
    <String, dynamic>{
      'id': 5,
      'title': 'Comment améliorer le référencement de son site web',
      'slug': 'comment-ameliorer-le-referencement-de-son-site-web',
      'description':
          "Faire sa pub sur internet et dompter sa présence digitale afin de faire fructifier son business est l'enjeu de toutes entreprises en 2023 ect...",
      'createdAt': '2023-08-14T17:51:18.433Z',
      'updatedAt': '2023-08-14T17:51:18.433Z',
      'deletedAt': null,
      'picture': {
        'src': '75a534fc-6617-4877-bce9-3649bf5d38e8-842127201-files/images/books-1.jpg',
    ...
    <String, dynamic>{
      'id': 4,
      'title': 'Ce que je pense de Ionic',
      'slug': 'ce-que-je-pense-de-ionic',
      'description':
          "Ionic est le nouveau framework de google pour créer des applications mobile. Cependant, au vu de la faciliter du langage dart, le framework arrive à conquérir des sections sur lesquelles on ne l'attendait pas.",
      'createdAt': '2023-08-14T17:51:15.995Z',
      'updatedAt': '2023-08-14T17:51:15.995Z',
      'deletedAt': null,
      'picture': {
        'src': '75a534fc-6617-4877-bce9-3649bf5d38e8-842127201-files/images/app-3.jpg',
        'alt': "Image du projet 'Mon site web 6 n° 3'",
      },
      'category': {
        'id': 5,
    ...
    <String, dynamic>{
      'id': 3,
      'title': 'Ce que je pense de Flutter',
      'slug': 'ce-que-je-pense-de-flutter',
      'description':
          "Flutter est le nouveau framework de google pour créer des applications mobile. Cependant, au vu de la faciliter du langage dart, le framework arrive à conquérir des sections sur lesquelles on ne l'attendait pas.",
      'createdAt': '2023-08-14T17:51:15.995Z',
      'updatedAt': '2023-08-14T17:51:15.995Z',
      'deletedAt': null,
      'picture': {
        'src': '75a534fc-6617-4877-bce9-3649bf5d38e8-842127201-files/images/app-2.jpg',
        'alt': "Image du projet 'Mon site web 6 n° 3'",
      },
      'category': {
        'id': 5,
    ...
    <String, dynamic>{
      'id': 2,
      'title': 'Quels est le meilleur framework front',
      'slug': 'quels-est-le-meilleur-framework-front',
      'description':
          "Angular, React, Vuejs sont les frameworks les plus utilisés en front, mais lequel est le meilleur. Pourquoi choisir un framework particulier plutôt qu'un autre. Je vais vous présenter les vrai éléments qui évitera de prendre une mauvaise décision.",
      'createdAt': '2023-08-14T17:51:13.395Z',
      'updatedAt': '2023-08-14T17:51:13.395Z',
      'deletedAt': null,
      'picture': {
        'src': '75a534fc-6617-4877-bce9-3649bf5d38e8-842127201-files/images/books-2.jpg',
        'alt': 'Hello world',
      },
      'category': {
        'id': 5,
    ...
    <String, dynamic>{
      'id': 1,
      'title': 'Comment créer une application web avec Angular',
      'slug': 'comment-creer-une-application-web-avec-angular',
      'description':
          "Cette article vous présentera tout le processus de construction d'une application web avec un framework complet (Angular). ect...",
      'createdAt': '2023-08-14T17:51:11.442Z',
      'updatedAt': '2023-08-14T17:51:11.442Z',
      'deletedAt': null,
      'picture': {
        'src': '75a534fc-6617-4877-bce9-3649bf5d38e8-842127201-files/images/app-1.jpg',
        'alt': 'Hello world',
      },
      'category': {
        'id': 5,
