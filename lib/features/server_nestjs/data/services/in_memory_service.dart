...
abstract class InMemoryService {
  factory InMemoryService(FlutterSecureStorage secureStorage, {String baseUrl}) = _InMemoryService;

  Future<HttpResponse<dynamic>> getEnvironments();
  Future<HttpResponse<dynamic>> postEnvironments({required String body});
}

class _InMemoryService implements InMemoryService {
  _InMemoryService(this._secureStorage, {this.baseUrl}) {
