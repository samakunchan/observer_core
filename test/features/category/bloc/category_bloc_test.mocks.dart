...
// in observer_core/test/features/category/bloc/category_bloc_test.dart.
...
import 'package:observer_core/features/authentication/tokens/datas/models/auth_token/auth_token_model.dart'
    as _i3;
import 'package:observer_core/features/features_export.dart' as _i7;
...
/// A class which mocks [AbstractInMemoryApiNestjsRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockAbstractInMemoryApiNestjsRepository extends _i1.Mock
    implements _i4.AbstractInMemoryApiNestjsRepository {
  MockAbstractInMemoryApiNestjsRepository() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<_i2.Either<_i4.Failure, _i6.HttpResponse<dynamic>>>
      upsertResponses(_i4.UpsertParams? params) => (super.noSuchMethod(
            Invocation.method(
              #upsertResponses,
              [params],
            ),
            returnValue: _i5.Future<
                    _i2.Either<_i4.Failure, _i6.HttpResponse<dynamic>>>.value(
                _FakeEither_0<_i4.Failure, _i6.HttpResponse<dynamic>>(
              this,
              Invocation.method(
                #upsertResponses,
...
/// A class which mocks [CategoryHandler].
///
/// See the documentation for Mockito's code generation for more information.
class MockCategoryHandler extends _i1.Mock implements _i7.CategoryHandler {
  MockCategoryHandler() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> handleAllFailures({
    required _i4.Failure? failure,
    required _i8.Emitter<_i7.CategoryState>? emit,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #handleAllFailures,
