...
import 'package:observer_core/features/category/selectors/categories_server_offline_selector.dart';

void main() {
  group('Given a widget CategoriesServerOfflineSelector.', () {
        ...
        await tester.pumpWidget(
          MaterialApp(
            home: BlocProvider<CategoryBloc>(
              ...
              child: CategoriesServerOfflineSelector(
